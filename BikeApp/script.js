...
function filterBikes(selectedTerrains, selectedFrame, selectedMotor) {
    ...
    const bikes = [
        ...
        { name: "Aventon Aventure 2 ST", image: "images/aventure2so.jpg", terrains: ["pavement", "dirt", "gravel", "snow_ice"], motor: "750", frame: "step_through", specs: "Motor: 750Watts Battery: 15AH Range: 100km Top Speed :32km/hr", buyURL: 'https://ebikeedmonton.com/products/aventon-aventure-2-step-over?_pos=1&_psq=aven&_ss=e&_v=1.0' },
        ...
        { name: "Aventon Level 2 ST", image: "images/Level2_SO.jpg", terrains: ["pavement", "dirt"], motor: "500", frame: "step_through", specs: "Motor: 500Watts Battery: 14AH Range: 100km Top Speed :32km/hr", buyURL: 'https://ebikeedmonton.com/products/copy-of-aventon-level-2-step-through?_pos=1&_sid=0a06855f2&_ss=r' },
